...
if (isset($_POST['login'])) {
      ...
      $sqlLogin="SELECT senha_usuario, user_usuario from tb_usuario where user_usuario='$usuario' and senha_usuario='$senha';";
          if($result=pg_query($conexao,$sqlLogin)){
                      ...
                      //Uma nova sessão de usuário é iniciada.
                        ...
                        $exec=pg_query($conexao,$sqlLogin);
                         while ($dados=pg_fetch_array($exec)){
                           $_SESSION['usuario']= $dados['user_usuario'] ;
                         }
